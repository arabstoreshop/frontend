    ...
    <>
      ...
      <section className="relative overflow-hidden bg-brand py-16 text-white sm:py-20">
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6">
          ...
          <h2 className="text-3xl font-extrabold sm:text-4xl">ابدأ بروتين نسيم اليوم</h2>
          <p className="mx-auto mt-4 max-w-2xl leading-8 text-white/85">
            اختر منتجاً واحداً أو اجمع عدة منتجات في باقة متكاملة. الدفع عند الاستلام، والطلب يتم خلال أقل من دقيقة.
          </p>
          <div className="mt-8">
            <Button size="xl" variant="secondary" className="min-h-[44px] font-bold text-brand" asChild>
...
function CareHero({ href }: { href: (path: string) => string }) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-50 via-cream to-white">
      ...
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
        <div className="space-y-7">
          <div className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-semibold text-brand shadow-sm ring-1 ring-brand/20">
            <ShieldCheck className="h-4 w-4" />
            عناية حساسة · 9 منتجات · السعودية
          </div>
          <div className="space-y-4">
            <h1 className="text-4xl font-extrabold leading-tight text-gray-950 sm:text-5xl lg:text-6xl">
              راحة خاصة، طلب واضح
              <span className="block text-brand">ادفع عند الاستلام داخل السعودية</span>
            </h1>
            <p className="max-w-xl text-lg leading-8 text-gray-600">
              9 منتجات للعناية الحساسة — من الراحة الفورية إلى الوقاية اليومية. 199 / 279 / 349 ريال. تغليف خاص بدون إحراج.
            </p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button size="xl" className="min-h-[44px]" asChild>
              <Link href={href("/collection")}>
                تسوّق الآن
                <ArrowLeft className="h-5 w-5" />
              </Link>
            </Button>
            <Button size="xl" variant="outline" className="min-h-[44px]" asChild>
              <Link href="#problems">ما هي مشكلتك؟</Link>
            </Button>
          </div>
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <p className="text-sm font-medium text-gray-700">4.8/5 من +2,400 عميل</p>
          </div>
        </div>
        <div className="relative">
          <div className="relative mx-auto aspect-square max-w-md overflow-hidden rounded-[2rem] bg-gradient-to-br from-brand-100 to-sand shadow-2xl">
            ...
            <div className="absolute bottom-5 right-5 rounded-2xl bg-white/95 p-4 shadow-lg backdrop-blur">
              <p className="text-sm font-bold text-gray-950">نسيم للعناية</p>
              <p className="mt-1 text-xs text-gray-500">199 / 279 / 349 ريال</p>
            </div>
          </div>
...
function BeautyHero({ href }: { href: (path: string) => string }) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#f7f3ef] via-cream to-white">
      <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
        <div className="space-y-7">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-xl text-lg leading-8 text-gray-600">
              ثلاث مشاكل، حلّين لكل وحدة: موضعي + جامي حلال. 199 / 279 / 388 د.م. الدفع عند الاستلام فالمغرب.
            </p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button size="xl" className="min-h-[44px] bg-[#2a0f16] hover:bg-[#3d1822]" asChild>
              <Link href={href("/collection")}>
                شوفي المجموعة
                <ArrowLeft className="h-5 w-5" />
              </Link>
...
function ProblemPicker({ href }: { href: (path: string) => string }) {
  return (
    <section id="problems" className="bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          <p className="mb-3 text-sm font-bold text-brand">تسوّق حسب ما يزعجك</p>
          <h2 className="text-3xl font-extrabold text-gray-950 sm:text-4xl">ما هي مشكلتك الأساسية؟</h2>
          <p className="mt-4 leading-7 text-gray-600">
            البواسير مشكلة مركّبة تحتاج حلولاً متعددة. اختر حسب ما يزعجك الآن ونسيم يرشّحلك المنتج الأنسب.
          </p>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="text-3xl font-extrabold text-gray-950 sm:text-4xl">مجموعة نسيم المتكاملة</h2>
            <p className="mt-3 max-w-2xl leading-7 text-gray-600">
              9 منتجات متخصصة — 199 / 279 / 349 ريال · الدفع عند الاستلام داخل السعودية.
            </p>
          </div>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-10 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <h2 className="text-3xl font-extrabold text-gray-950 sm:text-4xl">نسيم للجمال — 6 منتجات</h2>
            <p className="mt-3 max-w-2xl leading-7 text-gray-600">
              ثلاث مشاكل: الشعر، البشرة، العين. 199 / 279 / 388 د.م. · الدفع عند الاستلام فالمغرب.
            </p>
          </div>
          <Button variant="outline" asChild>
